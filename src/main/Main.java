...
public class Main {
    ...
    static PracticaBucles practicaCondicionales = new PracticaCondicionales();
    ...
    public static void main(String[] args) {
        ...
        System.out
                .println("practicaArreglos.ejercicio2(new int[]{1, 2, 3, 4, 5}); // Llama al ejercicio 2 de arreglos");
        System.out.println("\nPuedes llamar directamente a los métodos en este archivo.XD");
        practicaCondicionales.ejercicio1(2);
    }
}
